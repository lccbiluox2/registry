...
public class StringSchemaProvider extends AbstractSchemaProvider {
    ...
    public String getName() {
        return "string schema provider";
    }

    @Override
    public String getDescription() {
        return "This provider supports string schemas. You can find more information about avro at http://avro.apache.org";
    }
